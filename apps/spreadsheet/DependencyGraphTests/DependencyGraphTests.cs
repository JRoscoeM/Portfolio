...
public class DependencyGraphTest
{
    ...
    public void What()
    {
        ...
        graph.AddDependency("x", "c");

        CollectionAssert.AreEqual(dependeesList, graph.GetDependees("c").ToList());
    }
    [TestMethod()]
    public void TestAdd()
    {
        ...
        dependeesList.Add("a");
        dependentsList.Add("b");

        DependencyGraph dg = new DependencyGraph();
        dg.AddDependency("a", "b");
        CollectionAssert.AreEqual(dependeesList, dg.GetDependees("b").ToList());
        CollectionAssert.AreEqual(dependentsList, dg.GetDependents("a").ToList());

        dg.AddDependency("a", "c");
        dependentsList.Add("c");
        CollectionAssert.AreEqual(dependentsList, dg.GetDependents("a").ToList());

        dg.AddDependency("x", "c");

        dependeesList.Add("x");
        CollectionAssert.AreEqual(dependeesList, dg.GetDependees("c").ToList());
    ...
    public void Test ()
    {
        ...
        CollectionAssert.AreEqual(dependeesList, graph.GetDependees("b").ToList());
        CollectionAssert.AreEqual(dependentsList, graph.GetDependents("a").ToList());
