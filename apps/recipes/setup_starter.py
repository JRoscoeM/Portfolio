...
for info in USERS:
    ...
    # Predictable classroom passwords are useful locally but unsafe on a public site.
    if settings.DEBUG:
    ...
    login_status = "local demo password enabled" if settings.DEBUG else "login disabled"
    print(f"Ready: {info['username']} ({login_status})")
